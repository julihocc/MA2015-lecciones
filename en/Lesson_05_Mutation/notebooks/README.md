...
- [`lesson_05_mutation_reach.ipynb`](lesson_05_mutation_reach.ipynb) � how rate, step size, and fitness interact. 33 cells, 11 semantic outputs, 4 inline figures.
- [`lesson_05_permutation_mutation.ipynb`](lesson_05_permutation_mutation.ipynb) � mutation operators that preserve permutations. 21 cells, 7 semantic outputs, 2 inline figures.
