...
- [`lesson_09_knapsack.ipynb`](lesson_09_knapsack.ipynb) � binary representation, repair, operators, and exact comparison. 39 cells, 13 semantic outputs, 5 inline figures.
- [`lesson_09_scheduling.ipynb`](lesson_09_scheduling.ipynb) � binary rosters, feasibility repair, and objective quality. 39 cells, 13 semantic outputs, 5 inline figures.
- [`lesson_09_radar.ipynb`](lesson_09_radar.ipynb) � coverage, penalties, binary operators, and exhaustive comparison. 39 cells, 13 semantic outputs, 5 inline figures.
