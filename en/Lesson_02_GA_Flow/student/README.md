...
- [`lesson_02_ga_flow.ipynb`](lesson_02_ga_flow.ipynb) � the five phases, injected objectives, metrics, stopping, and stepped landscapes. 39 cells, 13 semantic outputs, 5 inline figures.
