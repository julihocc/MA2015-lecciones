...
- [`lesson_04_crossover.ipynb`](lesson_04_crossover.ipynb) � what crossover operators can and cannot create. 51 cells, 17 semantic outputs, 7 inline figures.
