...
- [`lesson_12_adaptive_ga.ipynb`](lesson_12_adaptive_ga.ipynb) � adaptive probabilities and populations against tuned fixed settings. 47 cells, 16 semantic outputs, 6 inline figures.
