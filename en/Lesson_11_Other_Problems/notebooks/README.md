...
- [`lesson_11_equations.ipynb`](lesson_11_equations.ipynb) � GA search, enumeration, and what exact certificates add. 33 cells, 11 semantic outputs, 4 inline figures.
- [`lesson_11_graph_colouring.ipynb`](lesson_11_graph_colouring.ipynb) � fitness-driven graph colouring and an exact backtracking comparison. 35 cells, 13 semantic outputs, 4 inline figures.
