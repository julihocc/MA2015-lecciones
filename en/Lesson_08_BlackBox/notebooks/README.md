...
- [`lesson_08_black_box.ipynb`](lesson_08_black_box.ipynb) � searching when the landscape and optimum are not directly available. 51 cells, 17 semantic outputs, 7 inline figures.
