...
- [`lesson_13_performance.ipynb`](lesson_13_performance.ipynb) � lazy evaluation, caching, snapshots, multiprocessing, and coarse fitness. 51 cells, 17 semantic outputs, 7 inline figures.
