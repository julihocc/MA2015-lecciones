...
- [`lesson_10_tsp.ipynb`](lesson_10_tsp.ipynb) � permutation-safe crossover and mutation for routes. 41 cells, 14 semantic outputs, 5 inline figures.
- [`lesson_10_team.ipynb`](lesson_10_team.ipynb) � role order, budget repair, and roster optimization. 41 cells, 14 semantic outputs, 5 inline figures.
