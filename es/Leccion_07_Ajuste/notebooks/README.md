...
- [`leccion_07_afinacion.ipynb`](leccion_07_afinacion.ipynb) � comparaciones de configuraciones con presupuesto controlado. 45 celdas, 15 salidas sem�nticas y 6 figuras integradas.
