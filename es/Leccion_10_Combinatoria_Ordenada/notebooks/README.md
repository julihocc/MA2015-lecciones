...
- [`leccion_10_tsp.ipynb`](leccion_10_tsp.ipynb) � cruza y mutaci�n seguras para permutaciones de rutas. 41 celdas, 14 salidas sem�nticas y 5 figuras integradas.
- [`leccion_10_equipo.ipynb`](leccion_10_equipo.ipynb) � orden de roles, reparaci�n de presupuesto y optimizaci�n de plantillas. 41 celdas, 14 salidas sem�nticas y 5 figuras integradas.
