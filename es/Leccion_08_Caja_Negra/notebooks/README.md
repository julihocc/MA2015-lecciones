...
- [`leccion_08_caja_negra.ipynb`](leccion_08_caja_negra.ipynb) � buscar cuando el paisaje y el �ptimo no est�n disponibles directamente. 51 celdas, 17 salidas sem�nticas y 7 figuras integradas.
