...
- [`leccion_03_presion_seleccion.ipynb`](leccion_03_presion_seleccion.ipynb) � c�mo las reglas de selecci�n cambian la oportunidad reproductiva. 45 celdas, 15 salidas sem�nticas y 6 figuras integradas.
