...
- [`leccion_09_mochila.ipynb`](leccion_09_mochila.ipynb) � representaci�n binaria, reparaci�n, operadores y comparaci�n exacta. 39 celdas, 13 salidas sem�nticas y 5 figuras integradas.
- [`leccion_09_horarios.ipynb`](leccion_09_horarios.ipynb) � roles binarios, reparaci�n de factibilidad y calidad del objetivo. 39 celdas, 13 salidas sem�nticas y 5 figuras integradas.
- [`leccion_09_radar.ipynb`](leccion_09_radar.ipynb) � cobertura, penalizaciones, operadores binarios y comparaci�n exhaustiva. 39 celdas, 13 salidas sem�nticas y 5 figuras integradas.
