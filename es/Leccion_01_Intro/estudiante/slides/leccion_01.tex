...
Cada $x$ del intervalo es una propuesta. La función le asigna una puntuación:
la curva tiene varias cimas, y buscamos la más alta. El seno recibe radianes;
una aptitud mayor es preferible.\\[0.7em]
En esta primera búsqueda, $x$ es un número sin unidades. Más adelante, en
Planta Física, representará decisiones de ingeniería sujetas a restricciones reales.
\end{frame}
