...
Cada número del intervalo es una posible respuesta. Cuanto más cerca esté de
$2$, mejor será su aptitud. Partiré de cuatro propuestas y seguiré cómo el
algoritmo elige, combina y modifica algunas para acercarse a esa meta.
\end{frame}
...
En la libreta compacta, la gráfica tendrá varias cimas:
$f(x)=\sin x-0.2|x|$ en $[-10,10]$. Allí construiré el algoritmo paso a paso
con selección por torneo, cruza por mezcla, mutación gaussiana y reemplazo
completo.
\medskip

Las reglas son las mismas, pero ahora acercarse a una cima no garantiza haber
encontrado la mejor. La gráfica y las corridas nos ayudarán a seguir la búsqueda.
\end{frame}
