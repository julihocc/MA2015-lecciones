...
\begin{frame}[fragile]{Ruta compartida de explicación y ejecución}
Preparación y modelo: 4 min; paisaje: 3; población: 4; selección: 5; cruza: 6; mutación: 6; ciclo completo: 7; semillas y comprobaciones: 5. Total: 40 minutos.\\[0.7em]
Ejecuta código preparado del notebook compacto. Predice, ejecuta e interpreta cada resultado. El tiempo incluye cómputo y transiciones; es una estimación, no un ensayo cronometrado.
\end{frame}
