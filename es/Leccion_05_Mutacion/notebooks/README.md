...
- [`leccion_05_alcance_mutacion.ipynb`](leccion_05_alcance_mutacion.ipynb) � c�mo interact�an tasa, tama�o de paso y aptitud. 33 celdas, 11 salidas sem�nticas y 4 figuras integradas.
- [`leccion_05_mutacion_permutacion.ipynb`](leccion_05_mutacion_permutacion.ipynb) � operadores de mutaci�n que conservan permutaciones. 21 celdas, 7 salidas sem�nticas y 2 figuras integradas.
