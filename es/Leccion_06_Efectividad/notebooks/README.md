...
- [`leccion_06_tasa_exito.ipynb`](leccion_06_tasa_exito.ipynb) � por qu� una corrida con semilla no estima una tasa de �xito. 33 celdas, 11 salidas sem�nticas y 4 figuras integradas.
