...
- [`leccion_12_ag_adaptativo.ipynb`](leccion_12_ag_adaptativo.ipynb) � probabilidades y poblaciones adaptativas frente a configuraciones fijas afinadas. 47 celdas, 16 salidas sem�nticas y 6 figuras integradas.
