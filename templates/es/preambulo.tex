...
\lstdefinestyle{pythonstyle}{
    ...
    escapeinside={(*@}{@*)},
    moredelim=**[l][\color{bandcolor}\bfseries]{\#\ ---\ NUEVO},
    moredelim=**[l][\color{bandcolor}\bfseries]{\#\ ---\ CAMBIADO},
    literate=
...
% Title slide macro: \tituloleccion{Número de lección}{Título}
\newcommand{\tituloleccion}[2]{
    \title{Lección #1: #2}
    \author{}
...
% Figure frame macro: \marcfigura{Título}{Ruta de la imagen}
\newcommand{\marcfigura}[2]{
    \begin{frame}{#1}
        \begin{center}
